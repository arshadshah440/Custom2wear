...
function get_swatches_ar($color)
{
    ...
    foreach ($color_termsa_ar as $color_term) {
        ...
        if ($term) {
            $output .= "<div class='swatch_ar' pid='" . $currentid . "' attr-name='" . $term->slug . "' style='" . $backdound . "'></div>";
        }
    }
...
// // Function to check and log product price when publishing a new product
// function check_product_price_on_publish($post_id)
// {
...
//     // If the price is not set, show an admin notice and prevent publishing
//     if (empty($price)) {
//         // Remove the action to prevent infinite loop
//         remove_action('save_post', 'check_product_price_on_publish');

//         // Add admin notice
//         add_action('admin_notices', function () {
//             echo '<div class="error"><p><strong>Error:</strong> Product price must be set before publishing.</p></div>';
//         });

//         // Prevent saving the post
//         wp_die('Error: Product price must be set before publishing.', 'Error', array('back_link' => true));
//     }
// }
// add_action('save_post', 'check_product_price_on_publish', 10, 2);

// // Function to check and log product price when updating a product
// function check_product_price_on_update($post_id)
// {
//     // Check if the post type is a product
//     if (get_post_type($post_id) != 'product') {
//         return;
...
//     // If the price is not set, show an admin notice and prevent updating
//     if (empty($price)) {
//         // Remove the action to prevent infinite loop
//         remove_action('woocommerce_process_product_meta', 'check_product_price_on_update');

//         // Add admin notice
//         add_action('admin_notices', function () {
//             echo '<div class="error"><p><strong>Error:</strong> Product price must be set before updating.</p></div>';
//         });

//         // Prevent saving the post
//         wp_die('Error: Product price must be set before updating.', 'Error', array('back_link' => true));
//     }
// }
// add_action('woocommerce_process_product_meta', 'check_product_price_on_update', 10, 2);
